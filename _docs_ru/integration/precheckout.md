...
* После этого авторизуйтесь на сайте и найдите запись с заголовком «setup-api» по аналогии с четвертым пунктом. 
...
* После этого зайдите на страницу категории и найдите запись с заголовком «ultimate.js» по аналогии с четвертым пунктом. 
...
* После этого зайдите на страницу товара и найдите запись с заголовком «ultimate.js» по аналогии с четвертым пунктом. 
...
* После этого добавьте товар в корзину и найдите запись с заголовком «ultimate.js» по аналогии с четвертым пунктом. 
